...
class Product
{
     ...
     * @Assert\Length( min=3, minMessage="Le nom du produit doit faire plus de 10 caractères", groups={"large-name"})
     */
    private $name;
    ...
    //     ]);
    //     $metadata->addPropertyConstraint('price', new Assert\NotBlank(['message' => 'Le nom du produit est obligatoire' ]));
    // }
